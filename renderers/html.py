...
def render(data: dict[str, Any], output_path: Path) -> None:
    ...
    quality_body = table([
        ...
        ("Does the test suite pass?", test_result.get("execution_status", "not_observed")),
        ...
        ("Test duration seconds", test_result.get("duration_seconds") if test_result.get("status") == "imported" else "Not observed"),
